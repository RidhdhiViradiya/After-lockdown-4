    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2020, 5, 4, 20, 39, 13, 822661))),
                ('exp_date', models.DateTimeField(default=datetime.datetime(2020, 5, 4, 20, 39, 13, 822661))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_payment', models.DateTimeField(default=datetime.datetime(2020, 5, 4, 20, 39, 13, 826683))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_date', models.DateTimeField(default=datetime.datetime(2020, 5, 4, 20, 39, 13, 827660))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2020, 5, 4, 20, 39, 13, 829643))),
                ('room_id', models.ForeignKey(db_column='room_id', on_delete=django.db.models.deletion.CASCADE, to='payingGuest.Room')),
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
